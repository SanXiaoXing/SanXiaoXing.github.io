...
$.ajax({
    ...
    success: function (res) {
        ...
        function showWelcome() {
            ...
            let dist = getDistance(116.222355,39.733378, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
            ...
            document.getElementsByClassName("announcement_content")[0].innerHTML =
                `欢迎来自 <span style="color: #4D64F0; font-weight: bold; font-family: KaiTi_GB2312;">${pos}</span> 的朋友。
                <br>${timeChange}<br>
        你距离<span style="color: #F3C05D; font-weight: bold;">SanXiaoXing </span> 约有 <span style="color: #4D64F0; font-weight: bold; font-family: DFKai-SB;">${dist}</span> 公里 ! <br>
        ${posdesc}
        <br><a href = "alipayqr://platformapi/startapp?saId=10000007&qrcode=K19614055k5f8n1q7ocjwya3R00"><img src="https://cdn.jsdelivr.net/gh/SanXiaoXing/Image@main/alipay_LucyMoney.jpg"></a>`;
        }
        showWelcome()
    }
})

/* <br><a href = "https://qr.alipay.com/fkx17741isruw6qqyum4h48"><img src="https://cdn.jsdelivr.net/gh/SanXiaoXing/Image/alipay.jpg"></a> */
